...
const coursesData: Record<string, any> = {
    'beginners-web-dev': {
        ...
        description: 'Learn the fundamentals of web development by building an interactive greeting card using HTML, CSS, and JavaScript.',
        longDescription: 'This course will take you from complete beginner to confidently building interactive web pages. You\'ll learn about the three core web technologies: HTML for structure, CSS for styling, and JavaScript for interactivity. Using CodePen, you\'ll see your code come to life instantly!',
        level: 'Beginner',
        duration: '1-2 hours',
        prerequisites: 'None - perfect for absolute beginners! Just create a free CodePen account.',
        whatYouLearn: [
            'Understand what HTML, CSS, and JavaScript do',
            'Build an interactive greeting card from scratch',
            'Use CodePen to write and preview code instantly',
            'Create buttons and input fields for user interaction',
            'Style your pages with colors and layouts',
